namespace TestSuite
{
    public class PriocTest
    {
        ...
        public PriocTest()
        {
            ...
            Escalonador = new Prioc(new ReadyQueue(Processos)); 
            Escalonador.Executa();
        }
        ...
        {
            Assert.True(Processos.ElementAt(0).TempoTermino == 7);
            Assert.True(Processos.ElementAt(1).TempoTermino == 2);
            Assert.True(Processos.ElementAt(2).TempoTermino == 14);
            Assert.True(Processos.ElementAt(3).TempoTermino == 10);
